    ...
    return (
    	<svg width="56" height="56" viewBox="0 0 56 56" className="group cursor-pointer transition-all duration-200">
      	<circle cx="28" cy="28" r="26" 
					fill="rgb(37, 20, 20, 0.3)" 
					stroke="rgb(255, 255, 255, 0.2)" 
					strokeWidth="1.5"
					className={`transition-all duration-200 [@media(hover:hover)]:group-hover:fill-white/[0.10] [@media(hover:hover)]:group-hover:stroke-white/[0.2] ${active ? 'fill-white/[0.10] stroke-white/[0.2]' : ''}`}
				/>
